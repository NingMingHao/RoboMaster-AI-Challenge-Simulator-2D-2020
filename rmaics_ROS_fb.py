...
### Add forcing broadcasting states
import sys
all_path = sys.path
...
from std_msgs.msg import Int16 ### forcing broadcasting states commands
import rospy
...
class rmaics(object):
    ...
    def init_pub_and_sub(self):
        ...
        self.force_broadcast_sub = rospy.Subscriber('/force_broadcast', Int16, callback=self.force_broadcast, queue_size=1)
        ## 2019
    ...
    def force_broadcast(self, int16_msg):
